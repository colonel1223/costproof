...
**Run** `review-20260907T192342Z`  ·  **Reporting backend** `watsonx:ibm/granite-4-h-small`  ·  **Generated** 2026-09-07T19:23:42Z
...
|---|---|---|---:|
| `get_spend_summary` | — | ✅ | 19 |
| `search_knowledge` | query=untagged spend with no business unit tag | ✅ | 2305 |
| `get_unit_economics` | — | ✅ | 6 |
| `check_commitment_waste` | — | ✅ | 7 |
| `search_knowledge` | query=unused commitment prepaid capacity never consumed | ✅ | 27 |
| `find_waste` | top_n=10 | ✅ | 67622 |
| `search_knowledge` | query=idle over-provisioned instance flat cost no weekend dip | ✅ | 37 |
