...
**Run** `review-20260907T094557Z`  ·  **Reporting backend** `deterministic`  ·  **Generated** 2026-09-07T09:45:57Z
...
|---|---|---|---:|
| `get_spend_summary` | — | ✅ | 53 |
| `search_knowledge` | query=untagged spend with no business unit tag | ✅ | 2436 |
| `get_unit_economics` | — | ✅ | 18 |
| `check_commitment_waste` | — | ✅ | 7 |
| `search_knowledge` | query=unused commitment prepaid capacity never consumed | ✅ | 24 |
| `find_waste` | top_n=10 | ✅ | 62872 |
| `search_knowledge` | query=idle over-provisioned instance flat cost no weekend dip | ✅ | 26 |
